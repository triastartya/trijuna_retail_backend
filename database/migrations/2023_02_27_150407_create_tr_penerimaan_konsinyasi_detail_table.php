...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tr_penerimaan_konsinyasi_detail', function (Blueprint $table) {
            $table->id('id_penerimaan_detail');
            $table->integer('id_penerimaan')->constrained('tr_penerimaan_konsinyasi');
            $table->integer('urut');
    ...
    {
        Schema::dropIfExists('tr_penerimaan_konsinyasi_detail');
    }
};
