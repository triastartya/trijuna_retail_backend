...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('ms_barang_kartu_stok', function (Blueprint $table) {
            ...
            $table->double('stok_awal',12,2);
            $table->double('nominal_awal',12,2);
            $table->double('stok_masuk',12,2);
            $table->double('nominal_masuk',12,2);
            $table->double('stok_keluar',12,2);
            $table->double('nominal_keluar',12,2);
            $table->double('stok_akhir',12,2);
            $table->double('nominal_akhir',12,2);
