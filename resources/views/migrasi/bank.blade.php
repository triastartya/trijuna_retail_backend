    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="card-title">Migrasi Data Bank From Json File</h4>
            </div>
            <div class="card-body">
                <form id="formBank">
                <div class="row" >
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <button type="button" class="btn btn-danger" ng-click="delBank()">Truncate Data</button>
                    </div>
                </div>
                </form>
            </div>
...
@section('ctrl')
    ...
    app.controller("myCtrl", function($scope,$http) {
        ...
        $scope.delBank= function(){
            Swal.fire({
                title: "Yakin menghapus semua data Bank?",
                showCancelButton: true,
                confirmButtonText: "Ya Hapus",
            }).then(function(result){
                console.log(result);
                if (result.isConfirmed) {
                    $http.get("{{ url('migrasi/bank/truncate') }}").then(function(res){
                        console.log('respon truncate Bank',res)
