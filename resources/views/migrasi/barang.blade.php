    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="card-title">Migrasi Data Barang From Json File</h4>
            </div>
            <div class="card-body">
                <form id="formBarang">
                <div class="row" >
        ...
        $scope.delBarang= function(){
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $http.get("{{ url('migrasi/barang/truncate') }}").then(function(res){
                        console.log('respon truncate Barang',res)
