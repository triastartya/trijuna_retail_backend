    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="card-title">Migrasi Data Divisi dan Group From Excel File</h4>
            </div>
            <div class="card-body">
...
@section('ctrl')
    ...
    app.controller("myCtrl", function($scope,$http) {
        ...
        $('#formCustomer').validate({
            ...
            submitHandler: function(e){
                ...
                $.ajax({
                    ...
                    {
                        if(data.success){
                            Swal.fire({icon: 'success',title: 'Divisi dan Group Berhasil Di Simpan',text: '',}).then(function(){
        ...
        $scope.delCustomer= function(){
            Swal.fire({
                title: "Yakin menghapus semua data Divisi Dan Group?",
                showCancelButton: true,
                confirmButtonText: "Ya Hapus",
            }).then(function(result){
                console.log(result);
                if (result.isConfirmed) {
                    $http.get("{{ url('migrasi/m_divisi/truncate') }}").then(function(res){
                        console.log('respon truncate Divisi',res)
