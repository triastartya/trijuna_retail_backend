    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="card-title">Migrasi Data Group From Json File</h4>
            </div>
            <div class="card-body">
                <form id="formGroup">
                <div class="row" >
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <button type="button" class="btn btn-danger" ng-click="delGroup()">Truncate Data</button>
                    </div>
                </div>
                </form>
            </div>
...
@section('ctrl')
    ...
    app.controller("myCtrl", function($scope,$http) {
        ...
        $scope.delGroup= function(){
            Swal.fire({
                title: "Yakin menghapus semua data Group?",
                showCancelButton: true,
                confirmButtonText: "Ya Hapus",
            }).then(function(result){
                console.log(result);
                if (result.isConfirmed) {
                    $http.get("{{ url('migrasi/group/truncate') }}").then(function(res){
                        console.log('respon truncate Group',res)
