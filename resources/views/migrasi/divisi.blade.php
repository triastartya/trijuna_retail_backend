    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="card-title">Migrasi Data Divisi From Json File</h4>
            </div>
            <div class="card-body">
                <form id="formDivisi">
                <div class="row" >
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <button type="button" class="btn btn-danger" ng-click="delDivisi()">Truncate Data</button>
                    </div>
                </div>
                </form>
            </div>
...
@section('ctrl')
    ...
    app.controller("myCtrl", function($scope,$http) {
        ...
        $scope.delDivisi= function(){
            Swal.fire({
                title: "Yakin menghapus semua data Divisi?",
                showCancelButton: true,
                confirmButtonText: "Ya Hapus",
            }).then(function(result){
                console.log(result);
                if (result.isConfirmed) {
                    $http.get("{{ url('migrasi/divisi/truncate') }}").then(function(res){
