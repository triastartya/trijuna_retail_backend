    ...
    <section class="content">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h4 class="card-title">Migrasi Data Merk From Json File</h4>
            </div>
            <div class="card-body">
                <form id="formMerk">
                <div class="row" >
                    ...
                    <div class="col-md-6 d-flex justify-content-end">
                        <button type="button" class="btn btn-danger" ng-click="delmerk()">Truncate Data</button>
                    </div>
                </div>
                </form>
            </div>
...
@section('ctrl')
    ...
    app.controller("myCtrl", function($scope,$http) {
        ...
        $scope.delmerk= function(){
            Swal.fire({
                title: "Yakin menghapus semua data merk?",
                showCancelButton: true,
                confirmButtonText: "Ya Hapus",
            }).then(function(result){
                console.log(result);
                if (result.isConfirmed) {
                    $http.get("{{ url('migrasi/merk/truncate') }}").then(function(res){
                        console.log('respon truncate merk',res)
