        ...
        try {
            ...
            foreach($json as $item){
                ...
                msBarangKartuStok::create([
                    ...
                    'nominal_masuk' => $item['HppAverage'] * $item['StokGudang'],
                    'stok_keluar' => 0,
                    'nominal_keluar' => 0,
                    'stok_akhir' => $item['StokGudang'],
                    'nominal_akhir' => $item['HppAverage'] * $item['StokGudang'],
                    'keterangan' =>'STOK AWAL',
                ]);
                //======== toko
                msBarangStok::create([
                ...
                msBarangKartuStok::create([
                    ...
                    'nominal_masuk' => $item['HppAverage'] * $item['StokToko'],
                    'stok_keluar' => 0,
                    'nominal_keluar' => 0,
                    'stok_akhir' => $item['StokToko'],
                    'nominal_akhir' => $item['HppAverage'] * $item['StokToko'],
                    'keterangan' =>'STOK AWAL',
                ]);
                //======== StokGudangRetur
                msBarangStok::create([
                ...
                msBarangKartuStok::create([
                    ...
                    'nominal_masuk' => 0,
                    'stok_keluar' => $item['HppAverage'] * $item['StokGudangRetur'],
                    'nominal_keluar' => 0,
                    'stok_akhir' => $item['StokGudangRetur'],
                    'nominal_akhir' => $item['HppAverage'] * $item['StokGudangRetur'],
                    'keterangan' =>'STOK AWAL',
                ]);
                //======== StokGudangBadStok
                msBarangStok::create([
                ...
                msBarangKartuStok::create([
                    ...
                    'nominal_masuk' => $item['HppAverage'] * $item['StockGudangBadStok'],
                    'stok_keluar' => 0,
                    'nominal_keluar' => 0,
                    'stok_akhir' => $item['StockGudangBadStok'],
                    'nominal_akhir' => $item['HppAverage'] * $item['StockGudangBadStok'],
                    'keterangan' =>'STOK AWAL',
                ]);
            }
            // DB::commit();
